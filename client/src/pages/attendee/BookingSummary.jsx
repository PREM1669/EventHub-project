...
export default function BookingSummary() {
  ...
  return <section className="mx-auto max-w-xl rounded-xl border border-slate-800 bg-slate-900 p-8">
    ...
    <div className="mt-6 flex items-center justify-between rounded-xl bg-slate-800 p-4"><span>{seat.label} · {seat.tier}</span><strong>{formatPrice(seat.price)}</strong></div>
